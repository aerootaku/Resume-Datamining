...
<div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed">
		...
		<div class="content">
			...
			<div class="block">
				<div class="block-header">
					<h3 class="block-title">Applicants</small></h3>
				</div>
				<div class="block-content block-content-full">
					...
					<table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
						...
						<tr>
							...
							<th style="width: 15%;">Job Applied</th>
							<th>Actions</th>
						</tr>
						</thead>
						<tbody>
	...
	<?php foreach ($applicants as $row): ?>
		<div class="modal fade" id="view<?= $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
	...
	<?php foreach ($applicants as $row): ?>
		<div class="modal fade" id="delete<?= $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
			<div class="modal-dialog modal-dialog-popin" role="document">
				<div class="modal-content">
					<?php echo form_open(base_url('admin/applicants/remove/'.$row['id'])); ?>
					<div class="block block-themed block-transparent mb-0">
						<div class="block-header bg-primary-dark">
							<h3 class="block-title">Delete Applicant</h3>
							<div class="block-options">
								<button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
									<i class="fa fa-fw fa-times"></i>
								</button>
