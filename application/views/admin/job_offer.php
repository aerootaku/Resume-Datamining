...
<div id="page-container" class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed">
		...
		<div class="content">
			...
			<div class="block">
				<div class="block-header">
					<h3 class="block-title">Job Offer</small></h3>
					<button class="btn btn-success text-right btn-sm" data-target="#createJob" data-toggle="modal"><i class="fa fa-plus"></i> New Job Offer</button>
				</div>
	...
	<?php foreach ($jobs as $row): ?>
		...
		<div class="modal-dialog modal-dialog-popin" role="document">
			<div class="modal-content">
				<?php echo form_open(base_url('admin/job_offer/update')); ?>
				<div class="block block-themed block-transparent mb-0">
					<div class="block-header bg-primary-dark">
						<h3 class="block-title">Update Job</h3>
						<div class="block-options">
							<button type="button" class="btn-block-option" data-dismiss="modal" aria-label="Close">
								<i class="fa fa-fw fa-times"></i>
							</button>
					...
					<div class="block-content font-size-sm">
						<div class="form-group">
							<label>Job Name</label>
							<input type="text" class="form-control" name="job_name" value="<?= $row['job_name']; ?>" required />
						</div>
						<div class="form-group">
							<label>Description</label>
							<textarea name="job_description" class="form-control" rows="5" required><?= $row['job_description']; ?></textarea>
						</div>
						<div class="form-group">
							<label>Years Experience</label>
							<select name="experience" class="form-control" required>
								<option value="<?= $row['year_experience']; ?>"><?= $row['year_experience']; ?> Years</option>
								<option value="1">1 Year</option>
								<option value="2">2 Years</option>
								<option value="3">3 Years</option>
								<option value="4">4 Years</option>
	...
	<?php foreach ($jobs as $row): ?>
		<div class="modal fade" id="delete<?= $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="modal-block-popin" aria-hidden="true">
			<div class="modal-dialog modal-dialog-popin" role="document">
				<div class="modal-content">
					<?php echo form_open(base_url('admin/job_offer/remove/'.$row['id'])); ?>
					<div class="block block-themed block-transparent mb-0">
						<div class="block-header bg-primary-dark">
